...
const App = () => {
    ...
    return (
        ...
        <div className="upload-form"><br/><br/>
  ...
  <div class="canvas">
    ...
    <div id="card">
    <p id="prompt">MERN Project</p>
      <div class="title">Summarization Using Gemini API</div>
      
    </div>
  </div>
</div><br/>
            <textarea class="input" name="text" value={text} onChange={handleTextChange} 
                placeholder="Enter your paragraph here" 
                rows="6" 
                cols="200"
            />
            <div class="sp">
      <button class="sparkle-button" onClick={handleSummarize} disabled={isLoading}>
        ...
        <span class="text">{isLoading ? 'Summarizing...' : 'Summarize'}</span>
      </button>
